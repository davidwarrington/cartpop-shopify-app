import { Button, Card, Stack, Subheading, TextContainer, TextField, TextStyle, Thumbnail } from "@shopify/polaris"
...
export function ProductList({
    ...
    if (!products || !products.length) {
        return (
            <Stack vertical>
                <TextContainer>
                    <TextStyle variation="subdued">No products selected. <TextStyle variation="strong">At least one product is required.</TextStyle></TextStyle>
                </TextContainer>
            </Stack>
        )
    }
