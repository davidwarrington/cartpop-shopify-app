    ...
    >
              ...
              <Stack vertical spacing="tight" distribution="center">
                ...
                >
                  ...
                  <Stack alignment="center" distribution="center" wrap={false}>
                    <div style={{ textAlign: "center" }}>
                      Share with customers memorable short checkout links with
                      link aliases.
                    </div>
                  </Stack>
                </Stack>
            ...
            <Stack.Item fill>
              <Stack vertical spacing="tight" distribution="center">
                ...
                <Stack distribution="center" wrap={false}>
                  <div style={{ textAlign: "center" }}>
                    Get detailed analytics including clicks, qr code scans, and
                    more.
                  </div>
                </Stack>
              </Stack>
      ...
      <FooterHelp>
        <TextStyle variation="subdued">
          All pricing is shown in USD. Learn more about <Link>CartPop Pro</Link>
          .
        </TextStyle>
      </FooterHelp>
    </Page>
